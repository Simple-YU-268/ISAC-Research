% Cell-Free ISAC Solver v6 - True Adaptive AP Count
% Start with 16 APs, if fail, reduce count and retry
...
fprintf('============================================================\n');
fprintf('Cell-Free ISAC Solver v6 (True Adaptive AP Count)\n');
fprintf('============================================================\n');
...
function best = solveOneScenario(cfg, scenario)
    ...
    % Try decreasing AP counts until success or minimum reached
...
function summarizeResults(cfg, results)
    ...
    fprintf('\n============================================================\n');
    fprintf('Summary v6 (True Adaptive AP Count)\n');
    fprintf('============================================================\n');
    ...
    fprintf('\nv6 Key Feature: True adaptive AP count reduction\n');
    fprintf('  - Start with 16 APs, reduce if fail\n');
    fprintf('  - Automatically find optimal AP count\n');
end

...
function result = solveOneScenario(cfg, scenario)
    ...
    % Robustness: to get wc SINR >= gamma, need nominal >= gamma / wc_factor
    wcFactorH = (1-cfg.epsilonH)/(1+cfg.epsilonH);  % = 0.739
    wcFactorG = (1-cfg.epsilonG)/(1+cfg.epsilonG);  % = 0.739
    ...
    for nActive = cfg.nActiveCandidates
        ...
        % Power for worst-case SINR target

% Cell-Free ISAC complete MATLAB solver.
%
...
%
% The joint problem is non-convex. This implementation uses the same
% decomposition adopted by the project: greedy AP selection, robust MMSE
% communication beamforming, matched-filter sensing beamforming, and a grid
% search over active AP count and power split.
...
fprintf('============================================================\n');
fprintf('Cell-Free ISAC Complete MATLAB Solver\n');
fprintf('============================================================\n');
...
function cfg = defaultConfig()
    ...
    % Per-AP power cap. Set to total/4 by default so the v2.2 four-AP
    % configuration is not artificially infeasible.

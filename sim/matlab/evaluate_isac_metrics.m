...
% Numerical leakage outside a selected AP-target pair is below this level in
% validated solutions; the threshold is far below the 1 mW default floor.
active_threshold_W = max(1e-8, 1e-6 * prm.Pmax);

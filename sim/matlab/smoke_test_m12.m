%% Smoke test for M=12 single trial
clear; clc;
addpath(pwd);

M = 12; Nt = 4; K = 4; P = 2; N_theta = 2;
Pmax_dBm = 20; Gamma_track = 10; seed = 2026;

fprintf('Generating scenario...\n');
prm = generate_scenario(M, Nt, K, P, N_theta, Pmax_dBm, Gamma_track, ...
    'AreaSize', 400, 'N_req', 1, 'eps_h', 0.05, 'seed', seed);

fprintf('Running baseline_alg2...\n');
tic;

...
print("训练...")
m = Net()
o = optim.AdamW(m.parameters(), lr=3e-5, weight_decay=3e-5)
sched = optim.lr_scheduler.CosineAnnealingLR(o, T_max=8000)
...
torch.save(m.state_dict(), 'isac_v77.pth')
...
print(f"v77 (4000样本, 300测试): SINR_min={min(r):.2f}dB, 平均={np.mean(r):.2f}dB, ≥0dB={sum(1 for x in r if x>=0)}/300")
